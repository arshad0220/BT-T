...
def run_multimodal_agent(ctx: JobContext, participant: rtc.RemoteParticipant):
    ...
    "You must access the internet for the latest AT&T plan rates and provide accurate information. "
    
    "Customize responses based on regional issues in the USA, addressing network outages, 5G availability, and plan differences. "

    "Handle high-priority scenarios: account access, billing disputes, plan changes, and technical issues. "
    ...
    "Use internet for latest information on plan rates of all plan and provide relevent information."
    ...
    chat_ctx.append(
        text= "Your goal is to resolve issues efficiently with minimal back-and-forth. "
         "Use real-time internet access for the latest AT&T plan rates and policies. "
         "Adapt responses based on regional AT&T service variations, ensuring hyper-relevant solutions. "
         "Prioritize high-impact cases: billing disputes, network issues, device upgrades, and security concerns. "
